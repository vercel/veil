...
export interface FS {
  /** Handle for the declared source "./files/everyblock.tf". */
  getFilesEveryblockTf(): File;
  /** Handle for the declared source "./files/messy.tf". */
  getFilesMessyTf(): File;
...
export interface RenderHookContext {
  ...
  resource: Resource<TfcheckSpec, Dependency>;
