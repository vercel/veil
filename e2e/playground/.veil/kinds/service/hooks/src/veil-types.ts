...
/** What a service tells a platform when it adopts it. */
export interface PlatformDependencyParams {
  team?: string;
}
...
export type Dependency =
  | { kind: "platform"; name: string; params: PlatformDependencyParams }
...
export interface RenderHookContext {
  ...
  resource: Resource<ServiceSpec, Dependency>;
